...
const OUTPUT_PATH = resolve(rootDir, "src/content/news/rss-data.json");
...
async function fetchRss() {
  ...
  const response = await fetch(RSS_URL, {
    headers: {
      "User-Agent": "MyCreativeHub/1.0 (+https://github.com/your-repo)",
  ...
  mkdirSync(resolve(rootDir, "src/content/news"), { recursive: true });
